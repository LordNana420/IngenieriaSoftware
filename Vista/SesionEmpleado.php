...
<nav class="navbar navbar-expand-lg navbar-dark bg-warning py-3 shadow">
  <div class="container-fluid">
    ...
    <ul class="navbar-nav ms-auto">
      <li class="nav-item"><a class="nav-link text-dark fw-semibold" href="#"><i class="bi bi-box-arrow-right"></i>
          Cerrar sesión</a></li>
    </ul>
  </div>
</nav>
...
<div class="container mt-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <button class="btn btn-success"><a href="?pid=Vista/registrarCliente.php" class="text-decoration-none text-light">
        <i class="bi bi-person-plus"></i> Nuevo Cliente</a></button>
  </div>
